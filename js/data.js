  ...
  modules: [
    {
      ...
      words: [
        ...
        { id:'e4', word:'морт',       type:'дара',    meaning:'сыну дыбысы',                          example:'Сына морт сынды.',                sound:'snap'      },
        { id:'e5', word:'қыңқ',       type:'дара',    meaning:'күшіктің әлсіз дыбысы',               example:'Күшік қыңқ етті.',                sound:'whimper'   },
